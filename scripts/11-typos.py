...
AI_AGENTS = [
    ...
    "omgili", "omgilibot", "webzio-extended", "imagesiftbot",
    "bytespider", "tiktokspider", "amazonbot",
    "youbot", "semrushbot-ocob", "petalbot",
    "velenpublicwebcrawler", "turnitinbot", "timpibot",
    "oai-searchbot", "icc-crawler", "ai2bot", "ai2bot-dolma",
    "dataforseobot", "awariobot", "awariosmartbot", "awariorssbot",
    "google-cloudvertexbot", "pangu-bot", "kangaroo bot", "sentibot",
    "img2dataset", "meltwater", "seekr",
    "peer39_crawler", "cohere-ai", "cohere-training-data-crawler",
    "duckassistbot", "scrapy", "cotoyogi", "aihitbot",
